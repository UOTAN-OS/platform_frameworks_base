        ...
        if (mIconDrawable != null) {
            ...
            RenderEffect ambientShadowEffect = RenderEffect.createColorFilterEffect(
                    ...
                    RenderEffect.createOffsetEffect(0f, 0f,
                            RenderEffect.createBlurEffect(mAmbientShadowRadius,
                                    mAmbientShadowRadius, Shader.TileMode.CLAMP)));
            RenderEffect keyShadowEffect = RenderEffect.createColorFilterEffect(
                    ...
                    RenderEffect.createOffsetEffect(mKeyShadowOffsetX, mKeyShadowOffsetY,
                            RenderEffect.createBlurEffect(
                                    mKeyShadowRadius, mKeyShadowRadius, Shader.TileMode.CLAMP)));
            if (ambientShadowEffect != null && keyShadowEffect != null) {
                shadowNode.setRenderEffect(RenderEffect.createBlendModeEffect(
