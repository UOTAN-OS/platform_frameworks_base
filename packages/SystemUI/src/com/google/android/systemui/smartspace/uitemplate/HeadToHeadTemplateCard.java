...
public class HeadToHeadTemplateCard extends BcSmartspaceCardSecondary {
    ...
    public boolean setSmartspaceActions(SmartspaceTarget target,
        ...
        if (isValid && templateData.getHeadToHeadAction() != null) {
            BcSmartSpaceUtil.setOnClickListener(this, target, templateData.getHeadToHeadAction(),
                    eventNotifier, "HeadToHeadTemplateCard", loggingInfo, 0);
        }
