...
public class CarouselTemplateCard extends BcSmartspaceCardSecondary {
    ...
    protected void onFinishInflate() {
        ...
        for (int i = 0; i < 4; i++) {
            ConstraintLayout column = (ConstraintLayout) ViewGroup.inflate(
                    getContext(), R.layout.smartspace_carousel_column_template_card, null);
    ...
    public boolean setSmartspaceActions(SmartspaceTarget target,
        ...
        long validItemsCount =
                carouselItems.stream()
                        .filter(item
                                -> item.getImage() != null && item.getLowerText() != null
