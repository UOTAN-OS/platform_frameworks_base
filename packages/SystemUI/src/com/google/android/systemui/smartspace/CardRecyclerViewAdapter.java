...
public final class CardRecyclerViewAdapter
    ...
    public static final Set<Integer> legacySecondaryCardResourceIdSet =
            BcSmartSpaceUtil.FEATURE_TYPE_TO_SECONDARY_CARD_RESOURCE_MAP.values().stream().collect(
                    Collectors.toSet());
    public static final Set<Integer> templateSecondaryCardResourceIdSet =
            BcSmartspaceTemplateDataUtils.TEMPLATE_TYPE_TO_SECONDARY_CARD_RES.values()
                    .stream()
    ...
    public final int getItemViewType(int position) {
        ...
        if (!isTemplateCard(target)) {
            Integer layoutId =
                    (Integer) BcSmartSpaceUtil.FEATURE_TYPE_TO_SECONDARY_CARD_RESOURCE_MAP.get(
        ...
        Integer layoutId =
                (Integer) BcSmartspaceTemplateDataUtils.TEMPLATE_TYPE_TO_SECONDARY_CARD_RES.get(
    ...
    public BcSmartspaceRemoteViewsCard getRemoteViewsCardAtPosition(int position) {
        SmartspaceCard card = getCardAtPosition(position);
        return card instanceof BcSmartspaceRemoteViewsCard ? (BcSmartspaceRemoteViewsCard) card
                                                           : null;
    }
    ...
    public final void onBindViewHolder(ViewHolder holder, int position) {
        ...
        card.bindData(target, dataProvider != null ? dataProvider.getEventNotifier() : null,
    ...
    public final ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (templateSecondaryCardResourceIdSet.contains(viewType)
            ...
            if (legacySecondaryCardResourceIdSet.contains(viewType)
                ...
                if (secondaryCardResId != null) {
                    legacyCard.setSecondaryCard((BcSmartspaceCardSecondary) inflater.inflate(
        ...
        card.getView().setLayoutParams(new ViewGroup.LayoutParams(
    ...
    public final void setDozeAmount(float dozeAmount) {
        ...
        transitioningTo = previousDozeAmount > dozeAmount ? TransitionType.TO_LOCKSCREEN
    ...
    public final void setTargets(List<SmartspaceTarget> list, Runnable runnable) {
        ...
        while (it.hasNext()) {
            ...
            if (smartspaceTarget.getFeatureType() == 34
                ...
                Log.e("SsCardRecyclerViewAdapter",
