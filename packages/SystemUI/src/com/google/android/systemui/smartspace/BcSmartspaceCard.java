...
public class BcSmartspaceCard extends ConstraintLayout implements SmartspaceCard {
    ...
    public final void bindData(SmartspaceTarget smartspaceTarget,
        ...
        if (headerAction != null) {
            ...
            if (bcSmartspaceCardSecondary != null) {
                ...
                this.mValidSecondaryCard = this.mSecondaryCard.setSmartspaceActions(
                        smartspaceTarget, this.mEventNotifier, bcSmartspaceCardLoggingInfo2);
            }
            ...
            Drawable iconDrawableWithCustomSize =
                    BcSmartSpaceUtil.getIconDrawableWithCustomSize(icon, context,
        ...
        if (baseAction != null) {
            int i3 = (baseAction.getExtras() == null || baseAction.getExtras().isEmpty())
                    ? -1
            ...
            if (baseAction.getIcon() != null) {
                ...
                drawable = BcSmartSpaceUtil.getIconDrawableWithCustomSize(icon2, context2,
                        context2.getResources().getDimensionPixelSize(
                                R.dimen.enhanced_smartspace_icon_size));
            }
            this.mBaseActionIconDrawable.setIcon(drawable);
            setBaseActionIconSubtitle(baseAction.getSubtitle(), baseAction.getContentDescription(),
                    this.mBaseActionIconDrawable);
            if (i3 != -1) {
                i2 = getClickedIndex(bcSmartspaceCardLoggingInfo2, i3);
            } else {
                Log.d("BcSmartspaceCard",
                        "Subcard expected but missing type. loggingInfo="
                                + bcSmartspaceCardLoggingInfo2.toString()
                                + ", baseAction=" + baseAction.toString());
            }
            BcSmartSpaceUtil.setOnClickListener(this.mBaseActionIconSubtitleView, smartspaceTarget,
                    baseAction, this.mEventNotifier, "BcSmartspaceCard",
                    bcSmartspaceCardLoggingInfo, i2);
        ...
        if (headerAction == null
            ...
            if (smartspaceAction2 == null
                ...
                if (headerAction != null) {
                    BcSmartSpaceUtil.setOnClickListener(this, smartspaceTarget, headerAction,
                            this.mEventNotifier, "BcSmartspaceCard", bcSmartspaceCardLoggingInfo,
                            0);
                }
            } else if (smartspaceAction2 != null) {
                BcSmartSpaceUtil.setOnClickListener(this, smartspaceTarget, smartspaceAction2,
                        this.mEventNotifier, "BcSmartspaceCard", bcSmartspaceCardLoggingInfo, 0);
            }
        } else {
            ...
            if (headerAction != null) {
                BcSmartSpaceUtil.setOnClickListener(this, smartspaceTarget, headerAction,
                        this.mEventNotifier, "BcSmartspaceCard", bcSmartspaceCardLoggingInfo2, 0);
            }
        }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @Override
    // androidx.constraintlayout.widget.ConstraintLayout, android.view.ViewGroup, android.view.View
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (z || this.mTouchDelegateIsDirty) {
            ...
            offsetDescendantRectToMyCoords((View) this.mBaseActionIconSubtitleView.getParent(),
            ...
            if (dimensionPixelSize > 0
                ...
                this.mBaseActionIconSubtitleHitRect.bottom = getHeight();
                setTouchDelegate(new TouchDelegate(
                        this.mBaseActionIconSubtitleHitRect, this.mBaseActionIconSubtitleView));
            }
        }
    }
    ...
    public final void setDozeAmount(float f) {
        ...
        if (smartspaceTarget != null && smartspaceTarget.getBaseAction() != null
        ...
        BcSmartspaceTemplateDataUtils.updateVisibility(this.mSecondaryCardGroup,
        ...
        if (smartspaceTarget2 == null || smartspaceTarget2.getFeatureType() != 30) {
            ...
            this.mTextGroup.setTranslationX(
                    ...
                    * this.mSecondaryCardGroup.getWidth() * (isRtl() ? 1 : -1));
    ...
    public final void setTitle(
        ...
        if (extras == null || !extras.containsKey("titleEllipsize")) {
            if (mTarget != null && mTarget.getFeatureType() == 2
