...
public class BcSmartspaceCard extends ConstraintLayout implements SmartspaceCard {
    ...
    public void bindData(SmartspaceTarget target,
        ...
        if (headerAction != null) {
            ...
            if (mSecondaryCardGroup != null) {
                ...
                BcSmartspaceTemplateDataUtils.updateVisibility(mSecondaryCardGroup,
                        mDozeAmount == 1f || !mValidSecondaryCard ? View.GONE : View.VISIBLE);
            }

            Icon icon = headerAction.getIcon();
            Drawable iconDrawable = icon != null
                    ? BcSmartSpaceUtil.getIconDrawableWithCustomSize(icon, getContext(),
        ...
        if (mBaseActionIconSubtitleView != null && baseAction != null) {
            Drawable baseIconDrawable = baseAction.getIcon() != null
                    ? BcSmartSpaceUtil.getIconDrawableWithCustomSize(baseAction.getIcon(),
                              getContext(),
                              getResources().getDimensionPixelSize(
                                      R.dimen.enhanced_smartspace_icon_size))
                    : null;
            ...
            if (baseIconDrawable == null) {
                ...
                if (clickedIndex == 0) {
                    Log.d("BcSmartspaceCard",
                            "Subcard expected but missing type. loggingInfo=" + loggingInfo
                                    + ", baseAction=" + baseAction);
                }
                BcSmartSpaceUtil.setOnClickListener(mBaseActionIconSubtitleView, target, baseAction,
                        mEventNotifier, "BcSmartspaceCard", loggingInfo, clickedIndex);
                ContentDescriptionUtil.setFormattedContentDescription("BcSmartspaceCard",
                        mBaseActionIconSubtitleView, baseAction.getSubtitle(),
    ...
    public void setDozeAmount(float dozeAmount) {
        ...
        if (mSecondaryCardGroup != null && mSecondaryCardGroup.getVisibility() == View.VISIBLE
                && mTextGroup != null) {
    ...
    public void setPrimaryOnClickListener(SmartspaceTarget target, SmartspaceAction action,
            BcSmartspaceCardLoggingInfo loggingInfo) {
        if (action != null) {
            BcSmartSpaceUtil.setOnClickListener(
                    this, target, action, mEventNotifier, "BcSmartspaceCard", loggingInfo, 0);
            if (mTitleTextView != null) {
                BcSmartSpaceUtil.setOnClickListener(mTitleTextView, target, action, mEventNotifier,
                        "BcSmartspaceCard", loggingInfo, 0);
            }
            if (mSubtitleTextView != null) {
                BcSmartSpaceUtil.setOnClickListener(mSubtitleTextView, target, action,
                        mEventNotifier, "BcSmartspaceCard", loggingInfo, 0);
            }
        }
    }
    ...
    public void setTitle(CharSequence text, CharSequence contentDescription, boolean useIcon) {
        ...
        Bundle extras = (mTarget != null && mTarget.getHeaderAction() != null)
        ...
        } else if (mTarget != null && mTarget.getFeatureType() == 2
    ...
    public void updateIconTint() {
        ...
        if (mBaseActionIconDrawable != null) {
            ...
            int subcardType = (baseAction != null && baseAction.getExtras() != null
