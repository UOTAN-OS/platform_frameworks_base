...
public abstract class BcSmartSpaceUtil {
    ...
    public static void setOnClickListener(View view, SmartspaceTarget target,
            SmartspaceAction action, BcSmartspaceDataPlugin.SmartspaceEventNotifier eventNotifier,
            String tag, BcSmartspaceCardLoggingInfo loggingInfo, int index) {
    ...
    public static void setOnClickListener(View view, SmartspaceTarget target, TapAction tapAction,
            BcSmartspaceDataPlugin.SmartspaceEventNotifier eventNotifier, String tag,
            BcSmartspaceCardLoggingInfo loggingInfo, int index) {
