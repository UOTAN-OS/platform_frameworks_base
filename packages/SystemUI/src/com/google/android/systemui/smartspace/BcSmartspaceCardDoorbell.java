...
public class BcSmartspaceCardDoorbell extends BcSmartspaceCardGenericImage {
    ...
    public boolean setSmartspaceActions(SmartspaceTarget target,
        ...
        if (!imageUris.isEmpty()) {
            ...
            float cornerRadius = getResources().getDimension(
            ...
            mLoadingScreenView.setBackgroundTintList(ColorStateList.valueOf(
    ...
    public static class DrawableWithUri extends DrawableWrapper {
        ...
        public DrawableWithUri(Uri uri, ContentResolver contentResolver, int heightInPx,
                float scaledCornerRadius, WeakReference<ImageView> imageViewRef,
