...
public class BaseTemplateCard extends ConstraintLayout implements SmartspaceCard {
    ...
    public void bindData(SmartspaceTarget target,
        ...
        boolean subtitleVisible = mSubtitleTextView.getVisibility() != View.GONE
        ...
        if (mTarget.getFeatureType() == 1 && mSubtitleSupplementalView != null
        ...
        if (mTemplateData.getPrimaryItem() != null
            ...
            BcSmartSpaceUtil.setOnClickListener(this, mTarget,
    ...
    public void setDozeAmount(float dozeAmount) {
        ...
        if (mSecondaryCardPane != null && mSecondaryCardPane.getVisibility() == View.VISIBLE
                && mTextGroup != null) {
    ...
    public void setUpTextView(DoubleShadowTextView textView,
