...
public class BaseTemplateCard extends ConstraintLayout implements SmartspaceCard {
    ...
    public final void bindData(SmartspaceTarget target,
            ...
            BcSmartspaceCardLoggingInfo loggingInfo, boolean shouldShowPageIndicator) {
        mTarget = null;
        mTemplateData = null;
        mFeatureType = 0;
        mLoggingInfo = null;
        ...
        if (mSecondaryCardPane != null) {
            BcSmartspaceTemplateDataUtils.updateVisibility(mSecondaryCardPane,
        ...
        if (mDateView == null) {
            ...
            TapAction tapAction =
                    new TapAction
                            .Builder((mTemplateData.getPrimaryItem() == null
                                             || mTemplateData.getPrimaryItem().getTapAction()
                                                     == null)
                                            ? UUID.randomUUID().toString()
                                            : mTemplateData.getPrimaryItem()
                                                      .getTapAction()
                                                      .getId()
                                                      .toString())
            ...
            BcSmartSpaceUtil.setOnClickListener(mDateView, mTarget, tapAction, eventNotifier,
                    "SsBaseTemplateCard", loggingInfo, 0);
        }
        setUpTextView(
        ...
        setUpTextView(mSubtitleSupplementalView, mTemplateData.getSubtitleSupplementalItem(),
                eventNotifier, true);
        setUpTextView(mSupplementalLineTextView, mTemplateData.getSupplementalLineItem(),
                eventNotifier, true);
        ...
        BcSmartspaceTemplateDataUtils.updateVisibility(mSubtitleGroup,
                mSubtitleTextView.getVisibility() != View.GONE
                                || mSubtitleSupplementalView.getVisibility() != View.GONE
                        ? View.VISIBLE
                        : View.GONE);
        if (target.getFeatureType() == 1 && mSubtitleSupplementalView != null
                && mSubtitleSupplementalView.getVisibility() == View.VISIBLE) {
            mSubtitleTextView.setEllipsize(null);
        }
        if (mDateView == null && mTemplateData.getPrimaryItem() != null
                && mTemplateData.getPrimaryItem().getTapAction() != null) {
            BcSmartSpaceUtil.setOnClickListener(this, target,
                    mTemplateData.getPrimaryItem().getTapAction(), eventNotifier,
                    "SsBaseTemplateCard", mLoggingInfo, 0);
            if (mDateView == null && mTitleTextView != null
                    && mTitleTextView.getVisibility() == View.VISIBLE && mSubtitleTextView != null
                ...
                if (mTemplateData.getPrimaryItem().getTapAction().getIntent() != null
                        && !mTemplateData.getPrimaryItem().getTapAction().getIntent().filterEquals(
                                mTemplateData.getSubtitleItem().getTapAction().getIntent())) {
                    Log.d("SsBaseTemplateCard",
                    ...
                    Log.d("SsBaseTemplateCard",
                        ...
                        || mTemplateData.getPrimaryItem().getTapAction().getPendingIntent().equals(
                                mTemplateData.getSubtitleItem()
                                        .getTapAction()
                                        .getPendingIntent())) {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        int padding = getResources().getDimensionPixelSize(R.dimen.subtitle_hit_rect_height)
    ...
    public final void setDozeAmount(float dozeAmount) {
        ...
        if (mTarget != null && mTarget.getBaseAction() != null
        ...
        mTextGroup.setTranslationX(
                ...
                * mSecondaryCardPane.getWidth() * (isRtl() ? 1 : -1));
    ...
    public final void setPrimaryTextColor(int color) {
        ...
        if (mSubtitleSupplementalView != null) {
            ...
            if (mTemplateData != null) {
                updateTextViewIconTint(mSubtitleSupplementalView,
    ...
    public final void setUpTextView(DoubleShadowTextView textView,
            BaseTemplateData.SubItemInfo subItemInfo,
            BcSmartspaceDataPlugin.SmartspaceEventNotifier eventNotifier, boolean z) {
        if (textView == null) {
        ...
        if (icon != null) {
            ...
            drawable.setIcon(
                    BcSmartSpaceUtil.getIconDrawableWithCustomSize(icon.getIcon(), getContext(),
                            getContext().getResources().getDimensionPixelSize(
                                    R.dimen.enhanced_smartspace_icon_size)));
            textView.setCompoundDrawablesRelative(drawable, null, null, null);
            ContentDescriptionUtil.setFormattedContentDescription("SsBaseTemplateCard", textView,
        ...
        if (mLoggingInfo != null && mLoggingInfo.mSubcardInfo != null
        ...
        BcSmartSpaceUtil.setOnClickListener(textView, mTarget, tapAction, eventNotifier,
                "SsBaseTemplateCard", mLoggingInfo, subCardRank);
    }
    ...
    public final void updateZenColors() {
        if (mSupplementalLineTextView != null) {
            ...
            if (BcSmartspaceCardLoggerUtil.containsValidTemplateType(mTemplateData)) {
                updateTextViewIconTint(mSupplementalLineTextView,
