...
public class CardPagerAdapter extends PagerAdapter implements CardAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (remoteViews != null) {
            ...
            BaseTemplateCard templateCard = enableCardRecycling.get()
                    ...
                    : null;
            if (templateCard != null && enableReducedCardRecycling.get()
            ...
            if (templateCard == null) {
                ...
                templateCard = (BaseTemplateCard) LayoutInflater.from(container.getContext())
            ...
            BcSmartspaceCard legacyCard = enableCardRecycling.get()
                    ...
                    : null;
            if (legacyCard != null && enableReducedCardRecycling.get()
            ...
            if (legacyCard == null) {
                ...
                if (layoutRes == 0) {
                    ...
                    legacyCard = (BcSmartspaceCard) LayoutInflater.from(container.getContext())
                                         .inflate(layoutRes, container, false);
                    ...
                    Integer secondaryRes =
                            (Integer) BcSmartSpaceUtil.FEATURE_TYPE_TO_SECONDARY_CARD_RESOURCE_MAP
                                    .get(featureType);
                    if (secondaryRes != null) {
                        BcSmartspaceCardSecondary secondaryCard =
                                (BcSmartspaceCardSecondary) LayoutInflater
    ...
    public void onBindViewHolder(ViewHolder holder) {
        ...
        if (target.getRemoteViews() != null) {
            ...
            BcSmartspaceDataPlugin.SmartspaceEventNotifier notifier = dataProvider != null ? event
                    -> dataProvider.notifySmartspaceEvent(event)
                    : null;
    ...
    public void setNonRemoteViewsHorizontalPadding(Integer padding) {
        ...
        for (int i = 0; i < viewHolders.size(); i++) {
            ...
            if (legacyCard != null && padding != null) {
                legacyCard.setPaddingRelative(padding, legacyCard.getPaddingTop(), padding,
                        legacyCard.getPaddingBottom());
            }
            BaseTemplateCard templateCard = getTemplateCardAtPosition(key);
            if (templateCard != null && padding != null) {
                templateCard.setPaddingRelative(padding, templateCard.getPaddingTop(), padding,
                        templateCard.getPaddingBottom());
            }
        }
    }
