...
public final class CardPagerAdapter extends PagerAdapter implements CardAdapter {
    ...
    public static class Companion {
        ...
        public static boolean useRecycledViewForActionsList(
            ...
            return IntStream.range(0, newActions.size())
                    .allMatch(i
                            -> useRecycledViewForAction(newActions.get(i), recycledActions.get(i)));
        }
        ...
        public final boolean useRecycledViewForNewTarget(
            ...
            return (newTemplateData == null || recycledTemplateData == null
    ...
    public enum TransitionType { NOT_IN_TRANSITION, TO_LOCKSCREEN, TO_AOD }
    ...
    public final class ViewHolder {
        ...
        public ViewHolder(int position, BcSmartspaceCard legacyCard, SmartspaceTarget target,
                BaseTemplateCard card, BcSmartspaceRemoteViewsCard remoteViewsCard) {
    ...
    public final void addDefaultDateCardIfEmpty(List<SmartspaceTarget> targets) {
        if (targets.isEmpty()) {
            targets.add(new SmartspaceTarget
                            .Builder("date_card_794317_92634",
                                    new ComponentName(
    ...
    public int getItemPosition(Object object) {
        ...
        if (currentTarget != null
                ...
                && currentTarget.getSmartspaceTargetId().equals(
                        holder.target.getSmartspaceTargetId())) {
    ...
    public final List<SmartspaceTarget> getLockscreenTargets() {
        return (mediaTargets.isEmpty() || !keyguardBypassEnabled) ? _lockscreenTargets
                                                                  : mediaTargets;
    }
    ...
    public final Object instantiateItem(ViewGroup container, int position) {
        ...
        if (target.getRemoteViews() != null) {
            ...
            BcSmartspaceRemoteViewsCard remoteViewsCard = enableCardRecycling.get()
            ...
            if (remoteViewsCard == null) {
                ...
                remoteViewsCard.setLayoutParams(new ViewGroup.LayoutParams(
            ...
            if (containsValidTemplateType) {
                ...
                BaseTemplateCard templateCard = enableCardRecycling.get()
                ...
                if (templateCard == null
                    ...
                    int layoutRes = (primaryItem == null
                    ...
                    templateCard = (BaseTemplateCard) inflater.inflate(
                            layoutRes, (ViewGroup) container, false);
                    ...
                    if (nonRemoteViewsHorizontalPadding != null) {
                        templateCard.setPaddingRelative(nonRemoteViewsHorizontalPadding,
                                templateCard.getPaddingTop(), nonRemoteViewsHorizontalPadding,
                ...
                BcSmartspaceCard legacyCard = enableCardRecycling.get()
                ...
                if (legacyCard == null
                    ...
                    if (layoutRes == 0) {
                        Log.w("SsCardPagerAdapter",
                                "No legacy card can be created for feature type: " + featureType);
                    } else {
                        legacyCard = (BcSmartspaceCard) inflater.inflate(
                                layoutRes, (ViewGroup) container, false);
                        legacyCard.mUiSurface = uiSurface;
                        if (nonRemoteViewsHorizontalPadding != null) {
                            legacyCard.setPaddingRelative(nonRemoteViewsHorizontalPadding,
                                    legacyCard.getPaddingTop(), nonRemoteViewsHorizontalPadding,
                                    legacyCard.getPaddingBottom());
                        }
                        Integer secondaryRes =
                                (Integer) BcSmartSpaceUtil
                                        .FEATURE_TYPE_TO_SECONDARY_CARD_RESOURCE_MAP.get(
                                                featureType);
    ...
    public final void onBindViewHolder(ViewHolder holder) {
        ...
        if (target.getRemoteViews() != null) {
            ...
            holder.remoteViewsCard.bindData(target,
                    dataProvider != null ? dataProvider.getEventNotifier() : null, loggingInfo,
        ...
        if (!hasValidTemplate) {
            ...
            holder.legacyCard.bindData(target,
                    dataProvider != null ? dataProvider.getEventNotifier() : null, loggingInfo,
                    smartspaceTargets.size() > 1);
        ...
        holder.card.bindData(target, dataProvider != null ? dataProvider.getEventNotifier() : null,
                loggingInfo, smartspaceTargets.size() > 1);
    ...
    public void setDozeAmount(float dozeAmount) {
        ...
        TransitionType newTransition = previousDozeAmount > dozeAmount
                ? TransitionType.TO_LOCKSCREEN
                : previousDozeAmount < dozeAmount ? TransitionType.TO_AOD
    ...
    public final void setNonRemoteViewsHorizontalPadding(Integer padding) {
        ...
        for (int i = 0; i < viewHolders.size(); i++) {
            ...
            if (legacyCardAtPosition != null) {
                legacyCardAtPosition.setPaddingRelative(padding,
                        legacyCardAtPosition.getPaddingTop(), padding,
            ...
            if (templateCardAtPosition != null) {
                templateCardAtPosition.setPaddingRelative(padding,
                        templateCardAtPosition.getPaddingTop(), padding,
        ...
        for (int i = 0; i < recycledCards.size(); i++) {
            ...
            baseTemplateCard.setPaddingRelative(padding, baseTemplateCard.getPaddingTop(), padding,
        ...
        for (int i = 0; i < recycledLegacyCards.size(); i++) {
            ...
            bcSmartspaceCard.setPaddingRelative(padding, bcSmartspaceCard.getPaddingTop(), padding,
    ...
    public void updateTargetVisibility() {
        List<SmartspaceTarget> targetList = !mediaTargets.isEmpty() ? mediaTargets
                : hasDifferentTargets                               ? _aodTargets
                                                                    : getLockscreenTargets();
        List<SmartspaceTarget> lockscreenTargets = getLockscreenTargets();
        boolean shouldUpdate = smartspaceTargets != targetList
                && (dozeAmount == 1f
                        || (dozeAmount >= 0.36f && transitioningTo == TransitionType.TO_AOD));
        boolean shouldUpdateLockscreen = smartspaceTargets != lockscreenTargets
                && (dozeAmount == 0f
                        || (1f - dozeAmount >= 0.36f
