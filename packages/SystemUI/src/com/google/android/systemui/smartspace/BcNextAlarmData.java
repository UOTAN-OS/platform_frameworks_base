...
public final class BcNextAlarmData {
    ...
    public static void setOnClickListener(View view,
            BcSmartspaceDataPlugin.SmartspaceEventNotifier smartspaceEventNotifier, int i) {
        ...
        BcSmartSpaceUtil.setOnClickListener(view, (SmartspaceTarget) null, SHOW_ALARMS_ACTION,
                smartspaceEventNotifier, "BcNextAlarmData", bcSmartspaceCardLoggingInfo, 0);
    }
}
