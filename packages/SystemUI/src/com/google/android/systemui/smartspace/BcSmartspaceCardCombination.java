...
public class BcSmartspaceCardCombination extends BcSmartspaceCardSecondary {
    ...
    public boolean fillSubCard(ConstraintLayout subCard, SmartspaceTarget target,
        ...
        BcSmartSpaceUtil.setOnClickListener(subCard, target, action, eventNotifier,
                "BcSmartspaceCardCombination", loggingInfo, 0);

        Drawable iconDrawable = action.getIcon() != null
                ? BcSmartSpaceUtil.getIconDrawableWithCustomSize(action.getIcon(), getContext(),
