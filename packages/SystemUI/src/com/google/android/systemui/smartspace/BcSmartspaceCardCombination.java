...
public class BcSmartspaceCardCombination extends BcSmartspaceCardSecondary {
    ...
    public final boolean fillSubCard(ConstraintLayout constraintLayout, SmartspaceTarget target,
            SmartspaceAction action, BcSmartspaceDataPlugin.SmartspaceEventNotifier eventNotifier,
        ...
        BcSmartSpaceUtil.setOnClickListener(constraintLayout, target, action, eventNotifier,
                "BcSmartspaceCardCombination", loggingInfo, 0);
    ...
    public boolean setSmartspaceActions(SmartspaceTarget target,
        ...
        boolean z = constraintLayout != null
                && fillSubCard(constraintLayout, target, action, eventNotifier, loggingInfo);
        boolean z2 = actionChips.size() > 1 && actionChips.get(1) != null;
        boolean fillSubCard = z2
                ? fillSubCard(mSecondSubCard, target, (SmartspaceAction) actionChips.get(1),
